...
experiment_data = [
    ...
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-4",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-5",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-6",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-7",
    ),
    ExperimentCreate(
        ...
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-8",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-9",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-10",
    ),
    ExperimentCreate(
        ...
        description="Description for entangling possibilities: quantum computing explorations experiment",
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-11",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-12",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-13",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-14",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-15",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-16",
    ),
    ExperimentCreate(
        ...
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-17",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-18",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-19",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-20",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-21",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-22",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-23",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-24",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-25",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-26",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-27",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-28",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-29",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-30",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-31",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-32",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-33",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-34",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-35",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-36",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-37",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-38",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-39",
    ),
    ExperimentCreate(
        ...
        tags=[],
        alias=f"{datetime.now(timezone.utc).strftime('%Y%m%d')}-40",
    ),
]
