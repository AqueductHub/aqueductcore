...
export type ExecuteExtensionMutation = { __typename?: 'Mutation', executeExtension: { __typename?: 'ExtensionExecutionResult', returnCode: number, stderr: string, stdout: string } };
