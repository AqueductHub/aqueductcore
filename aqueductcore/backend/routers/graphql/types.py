...
class TaskInfo:
    ...
    author: Optional[str] = strawberry.field(description="User, who stated the task.")
    ...
    task_runtime: str = strawberry.field(description="String representation of run time.")
